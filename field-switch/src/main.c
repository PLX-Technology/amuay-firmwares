...
static void mfs_tele_send(const struct device *ltc, const uint8_t mac[6])
{
	...
	for (int i = 0; i < MFS_PSE_PORTS; i++) {
		 ...
		 * el crudo deja el crudo vacio casi siempre: visto en hardware el
		 * 2026-08-05, solo 1 de 3 puertos traia cuenta, y de casualidad (entro
		 * una conversion nueva entre las dos lecturas).
		 *
		 ...
		 * perfectamente creible y en el panel se leeria como "conectado y sin
		 * consumo". */
